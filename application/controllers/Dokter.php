...
class Dokter extends CI_Controller
{
    ...
    $sql_rekamedis    = "SELECT tr.*,pd.no_rawat,pd.tanggal_daftar 
        ...
        $pdf->Cell(40, 7, '', 0, 0, 'C');
        $pdf->Cell(275, 7, 'Bendungan, Pagaden Barat, Subang Regency, West Java 41252', 0, 1, 'C');
        $pdf->Cell(80, 7, '', 0, 0, 'C');
        $pdf->Cell(190, 7, 'Telepon : 0853-2185-0665. E-mail: puskesmaspagadenbarat@gmail.com', 0, 1, 'C');
        ...
        $pdf->Cell(1,7, '',0,0,'C');
        $pdf->Cell(30, 7, 'Kode Dokter ', 1, 0, 'C');
        ...
        foreach ($resep as $r) {
        $pdf->Cell(1,7, '',0,0,'C');
        $pdf->Cell(30, 7, $r->kode_dokter, 1, 0, 'C');
        $pdf->Cell(75, 7, $r->nama_dokter, 1, 0, 'C');
        $pdf->Cell(40, 7, $r->jenis_kelamin, 1, 0, 'C');
