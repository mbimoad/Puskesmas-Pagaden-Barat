...
class Tbl_pendaftaranumum_model extends CI_Model
{

    public $table = 'tbl_pendaftaranumum';
    public $id = 'no_rawat';
    public $order = 'DESC';
    ...
    function get_all()
    {
        ...
        $this->db->join('tbl_pasienumum', 'tbl_pendaftaranumum.no_rekamedis = tbl_pasienumum.no_rekamedis');
        $this->db->join('tbl_dokter', 'tbl_pendaftaranumum.kode_dokter = tbl_dokter.kode_dokter');
        $this->db->join('tbl_poli', 'tbl_pendaftaranumum.id_poli = tbl_poli.id_poli');
