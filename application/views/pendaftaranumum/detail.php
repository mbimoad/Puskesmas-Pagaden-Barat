<div class="content-wrapper">
    <section class="content">
        ...
        <?php echo anchor('pendaftaranumum/cetakrekamedis/'.$no_rawat, 'Cetak Rekam Medis', "class='btn btn-danger' target='new'"); ?>
        <?php echo anchor('pendaftaranumum/cetakresepobat/'.$no_rawat, 'Cetak Resep Obat', "class='btn btn-success' target='new'"); ?>
        <?php echo anchor('pendaftaranumum/cetakrujukan/'.$no_rawat, 'Cetak Rujukan', "class='btn btn-info' target='new'"); ?>
...
<div class="modal fade" id="modaltindakan" tabindex="-1" role="dialog" aria-labelledby="modaltindakanLabel">
    <div class="modal-dialog modal-lg" role="dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open('pendaftaranumum/periksa_action'); ?>
    ...
    <div class="modal-dialog modal-lg" role="dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open('pendaftaranumum/resep_action'); ?>
                <table class="table table-bordered ">
    ...
    <div class="modal-dialog modal-lg" role="dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open('pendaftaranumum/rujukan_action'); ?>
                <table class="table table-bordered ">
...
<script type="text/javascript">
    ...
    function auto_nama_penyakit(){
        ...
        $("#nama_penyakit").autocomplete({
            source: "<?php echo base_url() ?>index.php/pendaftaranumum/autocompletePenyakit",
            minLength: 1
        });
    }
   ...
   function autonamaobat(){
        ...
        $("#nama_obat").autocomplete({
            source: "<?php echo base_url() ?>index.php/pendaftaranumum/autocompletemedicine",
            minLength: 1
        });
    }
    ...
    function autonamaobats(){
        ...
        $("#nama_obats").autocomplete({
            source: "<?php echo base_url() ?>index.php/pendaftaranumum/autocomplate",
            minLength: 1
        });
        autofillobat();
    }
    ...
    function auto_nama_tindakan(){
        ...
        $("#nama_tindakan").autocomplete({
            source: "<?php echo base_url() ?>index.php/pendaftaranumum/autocompleteTindakan",
            minLength: 1
        });
    }
     ...
     function auto_nama_poli(){
        ...
        $("#nama_poli").autocomplete({
            source: "<?php echo base_url() ?>index.php/pendaftaranumum/autocompletePoli",
            minLength: 1
        });
    }
    function autofill(){
    ...
    function autofillobat(){
        ...
        $.ajax({
            url: "<?php echo base_url()?>index.php/pendaftaranumum/autofillobat",
