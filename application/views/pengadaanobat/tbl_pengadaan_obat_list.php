<div class="content-wrapper">
    <section class="content">
        ...
        <table class="table table-bordered table-striped tbr" id="mytable" width="100%">
            <thead>
                <tr>
                    <th width="30px">No</th>
		    <th>No Trans</th>
                    ...
                    columns: [
                        {
                            "data": "id_pengadaan",
                            "orderable": false
                        },{"data": "no_trans"},{"data": "nama_obat"},{"data": "jenis_obat"},{"data": "harga_beli"},{"data": "jumlah"},{"data": "satuan"},{"data": "total"},
                        {
                            "data" : "action",
                            "orderable": false,
