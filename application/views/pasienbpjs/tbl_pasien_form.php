    ...
    <section class="content" >
        <div class="box box-warning box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">INPUT DATA PASIEN BPJS</h3>
            </div>
...
<table class='table table-bordered'>
      ...
      <tr>
          ...
          <td>
            <input type="text" class="form-control" name="status_pasien" id="status_pasien" placeholder="Status Pasien" value="BPJS" readonly />
          </td>
      </tr>
      ...
      <tr>
          <td width='200'>Alamat<?php echo form_error('alamat') ?></td><td>
      ...
      <tr>
        ...
        <td>
          <input type="text" class="form-control rt_rw_lengkap" name="rt_rw_lengkap" value="<?php echo $rt_rw_lengkap; ?>">
        </td>
      </tr>
      ...
      <tr>
        ...
        <td> 
  	     ...
  	     <a href="<?php echo site_url('pasienbpjs') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
        </td>
      </tr>
...
<script>
    ...
    function autofill(){
          ...
          $.ajax({
              url: "<?php echo base_url()?>index.php/pasienbpjs/autofill",
              data : "no_ktp="+no_ktp,
      ...
      function autocomplete_noktp(){
          //autocomplete
          $("#no_ktp").autocomplete({
              source: "<?php echo base_url() ?>index.php/pasienbpjs/ktpauto",
              minLength: 1
          });
