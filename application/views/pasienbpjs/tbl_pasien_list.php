            ...
            <div class="col-xs-12">
                ...
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        ...
                        <span style="font-size: 18px; font-weight: bold">BPJS</span>
                    </div>
            ...
            <div class='row'>
                <div class='col-md-12'>
                    <div style="padding-bottom: 10px;">
                        <?php echo anchor(site_url('pasienbpjs/create'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Tambah Data', 'class="btn btn-danger btn-sm"'); ?>
                        <?php echo anchor(site_url('pasienbpjs/cetak'), '<i class="fa fa-print" aria-hidden="true"></i> Cetak PDF', 'class="btn btn-success btn-sm"'); ?>
                        <?php echo anchor(site_url('pasienbpjs/excel'), '<i class="fa fa-print" aria-hidden="true"></i> Cetak Excel', 'class="btn btn-warning btn-sm"'); ?>
                        <?php echo anchor(site_url('pasienbpjs/hapudata'), '<i class="fa fa-print" aria-hidden="true"></i> Hapus Semua Data', 'class="btn btn-secondary btn-sm"'); ?>
                    </div>
                </div>
            
                <!-- Searching Data By Date -->
                <div class='col-md-12' style="padding-bottom: 10px;">
                    <form action="<?php echo site_url('pasienbpjs/index'); ?>" class="form-inline" method="get">

                        <div class="input-group">
                            <input type="text" class="form-control caridatanama" name="q" value="<?php echo $q; ?>" placeholder="No BPJS">
                            <span class="input-group-btn">
                                <?php 
                                    if ($q <> '')
                                    {
                                        ?>
                                        <a href="<?php echo site_url('pasienbpjs'); ?>" class="btn btn-default">Reset</a>
                                        <?php
                                    }
                                ?>            
                            </span>
                        ...
                        <?php if(($q <> '') && ($awal == '') && ($akhir == '')) { ?>
                            <div class="input-group">
                                <a href="<?php echo site_url('pasienbpjs/excel/' . $q)?>" class="btn btn-success">CETAK FILTER EXCEL</a>
                            </div>

                            <div class="input-group">
                                <a href="<?php echo site_url('pasienbpjs/cetak/' . $q)?>" class="btn btn-danger">CETAK FILTER PDF</a>
                            </div>
                        <?php } else if(($q == '') && ($awal <> '') && ($akhir <> '')) { ?>
                            <div class="input-group">
                            <a href="<?php echo site_url('pasienbpjs/excel/' . $awal . '/' . $akhir)?>" class="btn btn-success">CETAK FILTER EXCEL</a>
                            </div>
                                
                            <div class="input-group">
                                <a href="<?php echo site_url('pasienbpjs/cetak/' . $awal . '/' . $akhir)?>" class="btn btn-danger">CETAK FILTER PDF</a>
                            </div>
                        <?php } ?>
                    </form>
        ...
        <div class="row" style="margin-bottom: 10px">
            ...
            <th>Action</th>
                ...
                <td style="text-align:center" width="200px">
                    <?php 
                    echo anchor(site_url('pasienbpjs/update/'.$pasien->no_rekamedis),'<i class="fa fa-pencil-square-o" aria-hidden="true"></i>','class="btn btn-danger btn-sm"'); 
                    echo '  '; 
                    echo anchor(site_url('pasienbpjs/cetakkartu/').$pasien->no_rekamedis,'<i class="fa fa-print" aria-hidden="true"></i>','class="btn btn-danger btn-sm"'); 
                    echo '  '; 
                    echo anchor(site_url('pasienbpjs/delete/'.$pasien->no_rekamedis),'<i class="fa fa-trash-o" aria-hidden="true"></i>','class="btn btn-danger btn-sm" Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
                    ?>
                </td>
            </tr>
                    <?php
                ...
                <div class="box box-primary box-solid">
                    ...
                    <div class="box-body">
                        ...
                        <tr style="color:black; font-weight: none; text-align:center;">
                            <td style="font-size: 25px; width: 30px; height: 30px;"><?php echo $total_databpjs ?></td>
